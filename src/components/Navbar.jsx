      ...
      >
        ...
        <div className="max-w-[100rem] mx-auto px-8 lg:px-12 flex justify-between items-center relative z-10">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <a href="https://www.linkedin.com/in/kunal-chauhan" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300 transform hover:scale-110">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="flex flex-col space-y-6 text-center mt-10 px-6">
          ...
          <div className="flex justify-center space-x-8 mt-12 opacity-50">
             ...
             <a href="https://www.linkedin.com/in/kunal-chauhan" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500 transition-colors transform hover:scale-110">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                  <rect x="2" y="9" width="4" height="12"></rect>
                  <circle cx="4" cy="4" r="2"></circle>
