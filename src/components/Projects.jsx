...
const MISSIONS = [
  {
    ...
    description: 'Full-stack financial data platform with real-time IPO listings and complex backend architecture.',
    tech: ['Django', 'DRF', 'React.js', 'PostgreSQL', 'AWS'],
    image: imgSpiderman,
    link: '#',
  ...
  {
    id: '02',
    name: 'Burger Bot — AI Chatbot',
    description: 'Multimodal conversational AI with voice + text capabilities, powered by OpenAI and DialoGPT.',
  ...
  },
  {
    ...
    description: 'Automated AWS EC2 scaling system designed to optimize resource usage and reduce cloud expenses.',
    tech: ['Python', 'AWS', 'Boto3', 'Lambda'],
    image: imgSpiderman,
    link: '#',
  ...
  {
    id: '04',
    name: 'Lost & Found College System',
    description: 'Full-stack university platform for tracking lost items, featuring real-time updates and secure reporting.',
  ...
  return (
    ...
    >
      <div className="max-w-[90rem] mx-auto w-full relative z-10">
        ...
        {/* Header Block */}
        <div ref={headerRef} className="mb-20 md:mb-32 flex flex-col items-center text-center border-b border-white/5 pb-12">
          <p className="text-red-500 font-mono text-[10px] tracking-[0.5em] uppercase mb-4 opacity-70">[ Ops Archive // Portfolio ]</p>
          <h2 className="text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tighter text-white font-sans leading-none drop-shadow-lg mb-6">
          ...
          <p className="text-gray-500 font-light tracking-[0.1em] text-base md:text-lg max-w-xl leading-relaxed">
            A selective dossier of high-impact operations engineered for supreme performance and scale.
          </p>
        </div>
        
        {/* Grid Container */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl mx-auto place-items-center">
          {VISIONS.map(project => (
