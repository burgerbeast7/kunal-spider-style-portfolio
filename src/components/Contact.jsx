    ...
    >
      ...
      <div className="max-w-2xl w-full relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-12 animate-element">
          ...
          <p className="text-gray-400 font-light text-lg tracking-wide leading-relaxed max-w-xl mx-auto mb-10">
            Based in Palampur, India. Whether you have a groundbreaking tech vision, a complex application to build, or just want to talk shop—let’s collaborate and architect the digital tools of tomorrow.
          </p>

          <div className="flex flex-wrap justify-center gap-8 mb-12">
            <div className="flex flex-col items-center">
              <span className="text-red-500 font-mono text-[10px] uppercase tracking-widest mb-1">Email</span>
              <a href="mailto:kunalchauhan91837@gmail.com" className="text-white hover:text-red-400 transition-colors">kunalchauhan91837@gmail.com</a>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-red-500 font-mono text-[10px] uppercase tracking-widest mb-1">Phone</span>
              <a href="tel:+917807786372" className="text-white hover:text-red-400 transition-colors">+91 7807786372</a>
            </div>
          </div>
        </div>
